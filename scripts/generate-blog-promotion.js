...
const BLOG_INDEX = path.join(PUBLIC_DIR, 'news.html');
const BLOG_SITEMAP = path.join(PUBLIC_DIR, 'sitemap.xml');
...
<head>
    ...
    <link rel="canonical" href="${BASE_URL}/news/${slug}.html">
    <meta property="og:type" content="article">
    <meta property="og:url" content="${BASE_URL}/news/${slug}.html">
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": "${BASE_URL}/news/${slug}.html"
    }
    </script>
</head>
<body>
...
function updateSitemap({ dateString, slug }) {
  ...
  const loc = `${BASE_URL}/news/${slug}.html`;
